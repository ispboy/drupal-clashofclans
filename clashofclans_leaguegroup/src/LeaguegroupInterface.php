 ...
 */
interface LeaguegroupInterface extends ContentEntityInterface, EntityOwnerInterface, EntityChangedInterface {
   ...
   *
   * @return \Drupal\clashofclans_leaguegroup\LeaguegroupInterface
