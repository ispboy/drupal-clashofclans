...
namespace Drupal\clashofclans_clan\Plugin\Field\FieldWidget;
...
/**
 * Defines the 'clashofclans_clan' field widget.
 *
 * @FieldWidget(
 ...
 * )
 */
class ClanWidget extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#attributes']['class'][] = 'clashofclans-clan-elements';
    $element['#attached']['library'][] = 'clashofclans_clan/clashofclans_clan';
    ...
    foreach ($values as $delta => $value) {
      ...
      if ($value['tag'] === '') {
        ...
        if (isset($data['description'])) {
          $values[$delta]['description'] = $data['description'];
        }
      }
    }
    return $values;
